...
const Certifications = () => {
  ...
  const certifications = [
    { name: t('certifications.higherEducation'), color: 'from-indigo-600 to-purple-600', isHarvard: false, isIBM: false, isIFRS: false, isCybersecurity: false, isDataEngineering: false, isGoogle: false, isSENAI: false, isPython: false, isLinux: false, isJavaScript: false, isHigherEducation: true, previewUrl: 'https://i.postimg.cc/nrmWXJRc/doc-20221003-wa0020-221008213608-499bebfa-page-0001.jpg', hasSensitiveData: false },
